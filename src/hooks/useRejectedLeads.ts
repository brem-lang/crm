        ...
        .select(`
          *,
          leads(
            ...
            ftd_date, ftd_id, affiliate_id, advertiser_id, autologin, is_live,
            user_agent, platform, browser, comment, request_id, created_at,
            distributed_at, affiliates(name)
          ),
          advertisers(name)
        `)
        .order('created_at', { ascending: false });
