...
interface RejectedLeadsFilterBarProps {
  fromDate: Date;
  toDate: Date;
...
export function RejectedLeadsFilterBar({
  fromDate,
  toDate,
  onFromDateChange,
  onToDateChange,
    ...
    <div className="space-y-3">
      ...
      {onPageChange && onPageSizeChange && (
        <TablePagination
          ...
          extra={
            <Input
              placeholder="Search name, email, phone, IP, or lead ID..."
              value={freeSearch}
